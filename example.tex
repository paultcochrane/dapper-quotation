\documentclass[letterpaper]{dapper-quotation}
%\documentclass[letterpaper,currency=dollar]{dapper-quotation}
%\documentclass[letterpaper,currency=euro]{dapper-quotation}
%\documentclass[letterpaper,currency=pound]{dapper-quotation}
